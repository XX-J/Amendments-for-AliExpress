...
//    Отключаем перевод отзывов на английский
    if (/feedback.aliexpress.com/i.test(window.location) && window.parent.document.querySelector('#product-evaluation[marginheight]')) setTimeout(function () {
        document.querySelector('#cb-translate[checked]').click();
